...
export default function SubmissionsScreen() {
  ...
  const handleSubmit = () => {
    if (!selectedImage || !description || !selectedCategory) {
      Alert.alert('Missing Information', 'Please add an image, description, and category.');
      return;
    }
        ...
        <ScrollView className="flex-1">
          ...
          <View className="px-6 py-6">
            ...
            <Button
              ...
              disabled={!selectedImage || !description || !selectedCategory}>
      ...
      <View className="bg-blue-500 dark:bg-blue-600 pt-12 pb-6 px-6 rounded-b-3xl">
        <View className="flex-row items-center justify-between">
          <View>
            ...
            <Text className="text-white text-sm opacity-90 mt-1">
              {mockSubmissions.length} total reports
            </Text>
          </View>
          <TouchableOpacity
            onPress={() => setMode('add')}
